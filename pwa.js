...
const cacheName = 'fixit7SecondExtraXPKaitlyn-2020-11-20 20:21:54.235405'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'fixit7SecondExtraXPKaitlyn'.length) === 'fixit7SecondExtraXPKaitlyn') {
